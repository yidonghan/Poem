...
# from utils.camera_utils import direction_to_img_coord, img_coord_to_pano_direction, img_coord_from_hw, img_coord_to_sample_coord
...
class PanoGeoPredictor(GeoPredictor):
    ...
    def grads_to_normal(self, grads):
        from utils.camera_utils import img_coord_to_pano_direction, img_coord_from_hw
        grads = grads.cpu()
    ...
    def __call__(self, img, gen_res=512, reg_loss_weight=1e-1,):
        from utils.camera_utils import direction_to_img_coord, img_coord_to_sample_coord, img_coord_to_pano_direction, img_coord_from_hw
        '''
        :param img: [H, W, 3]
